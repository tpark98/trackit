...
export const users: User[] = [
  { id: 'user01', password: 'test', firstName: 'Alice', lastName: 'Smith', roles: 'manager', access: ['products'] }
];
...
export const emergencyContacts = [
  { id: '1', name: 'Plumber', phone: '555-123-4567' },
  { id: '2', name: 'Electrician', phone: '555-234-5678' },
  { id: '3', name: 'HVAC Technician', phone: '555-345-6789' },
];
